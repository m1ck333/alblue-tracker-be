...
public class ReferenceCheckService : IReferenceCheckService
{
    ...
    {
        return await _ordersDb.Set<AlblueMES.Modules.Orders.Domain.Entities.OrderItem>()
    ...
    {
        return await _ordersDb.Set<AlblueMES.Modules.Orders.Domain.Entities.OrderItemProcess>()
