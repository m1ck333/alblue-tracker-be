using AlblueMES.Modules.Orders.Application.Commands.DeleteAllNotifications;
using AlblueMES.Modules.Orders.Application.Commands.DeleteNotification;
using AlblueMES.Modules.Orders.Application.Commands.MarkAllNotificationsRead;
using AlblueMES.Modules.Orders.Application.Commands.MarkNotificationRead;
using AlblueMES.Modules.Orders.Application.Commands.MarkNotificationUnread;
using AlblueMES.Modules.Orders.Application.Queries.GetNotifications;
using AlblueMES.Modules.Orders.Application.Queries.GetUnreadNotificationCount;
using MediatR;
