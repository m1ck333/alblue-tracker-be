using AlblueMES.Modules.Orders.Application.Queries.Reports.GetProcessAverages;
using AlblueMES.Modules.Orders.Application.Queries.Reports.GetTimeTracking;
using AlblueMES.Modules.Orders.Application.Queries.Reports.GetWorkerHours;
