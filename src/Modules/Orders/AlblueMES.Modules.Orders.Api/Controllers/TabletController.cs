using AlblueMES.Modules.Orders.Application.Commands.PauseWork;
using AlblueMES.Modules.Orders.Application.Queries.Tablet.GetTabletActiveWork;
using AlblueMES.Modules.Orders.Application.Queries.Tablet.GetTabletIncoming;
using AlblueMES.Modules.Orders.Application.Queries.Tablet.GetTabletQueue;
using MediatR;
