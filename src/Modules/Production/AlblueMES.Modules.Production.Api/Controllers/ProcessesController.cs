...
using AlblueMES.Modules.Production.Api.Requests;
using AlblueMES.Modules.Production.Application.Commands.ActivateProcess;
using AlblueMES.Modules.Production.Application.Commands.AddSubProcess;
using AlblueMES.Modules.Production.Application.Commands.CreateProcess;
using AlblueMES.Modules.Production.Application.Commands.DeactivateProcess;
using AlblueMES.Modules.Production.Application.Commands.DeleteProcess;
using AlblueMES.Modules.Production.Application.Commands.DeactivateSubProcess;
using AlblueMES.Modules.Production.Application.Commands.ReorderProcesses;
using AlblueMES.Modules.Production.Application.Commands.ReorderSubProcesses;
using AlblueMES.Modules.Production.Application.Commands.UpdateProcess;
using AlblueMES.Modules.Production.Application.Commands.UpdateSubProcess;
using AlblueMES.Modules.Production.Application.Queries.GetProcessById;
using AlblueMES.Modules.Production.Application.Queries.GetProcesses;
using MediatR;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace AlblueMES.Modules.Production.Api.Controllers;
