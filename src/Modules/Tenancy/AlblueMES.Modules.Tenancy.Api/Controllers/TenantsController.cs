using AlblueMES.Modules.Tenancy.Api.Requests;
...
using AlblueMES.Modules.Tenancy.Application.Commands.UpdateTenantSettings;
using AlblueMES.Modules.Tenancy.Application.Queries.GetTenantById;
using AlblueMES.Modules.Tenancy.Application.Queries.GetTenants;
using AlblueMES.Modules.Tenancy.Application.Queries.GetTenantSettings;
using MediatR;
using Microsoft.AspNetCore.Mvc;

namespace AlblueMES.Modules.Tenancy.Api.Controllers;
